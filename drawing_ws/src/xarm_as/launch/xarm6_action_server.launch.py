...
def launch_setup(context, *args, **kwargs):
    ...
    node_executable = 'xarm_action_server'
    node_parameters = {}
    print('node_parameters: ', node_parameters)
    # robot planner launch
    # xarm_planner/launch/_robot_planner.launch.py
    robot_planner_node_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('xarm_as'), 'launch', '_action_server.launch.py'])),
        launch_arguments={
            'prefix': prefix,
            'hw_ns': hw_ns,
            'limited': limited,
