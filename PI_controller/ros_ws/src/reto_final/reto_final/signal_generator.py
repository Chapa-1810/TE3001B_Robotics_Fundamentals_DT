...
class My_Publisher(Node):
    ...
    def signal_timer_callback(self):
        ...
        if(type == 0):
            ...
            result = amplitude*np.sin(2*np.pi*graph_time*frequency) + offset
        elif(type == 2):
            result = amplitude*signal.square(2*np.pi*graph_time*frequency) + offset   
        elif(type == 3):
            result = amplitude*signal.sawtooth(2*np.pi*graph_time*frequency) + offset
